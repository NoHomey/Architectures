...
void animation::run_square(Adafruit_TLC5947& tlc, sound_color& c, const uint8_t& frame) {
  reset();
...
void animation::run_full_square(Adafruit_TLC5947& tlc, sound_color& c, const uint8_t& frame) {
  reset();
